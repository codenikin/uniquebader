        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-3 max-w-xs">
              ...
              maintainance work and Mechinery repairing and trading.Bader Technical works LLC
              provide the complete solution for Tensile membrane shades,Mild steel & stainless steel
              fabrication and erection.Our service include Design drawing and Engineering for
              fabrication&tensile membrane structures civil maintainance work and Mechinery
