    ...
    <div className="relative group">
      ...
      <div
        className="absolute left-0 right-0 w-[600px] bg-white dark:bg-gray-900 shadow-xl rounded-lg opacity-0 invisible 
            group-hover:opacity-100 group-hover:visible transition-all duration-200 grid grid-cols-2 overflow-hidden p-2"
      >
        ...
        <div className="relative">
          <img src="/nav.jpg" alt="Support" className="w-half h-full object-cover p-2" />
