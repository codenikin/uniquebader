...
const Megalink = ({ label, url, submenus }: Props) => {
  return (
    <div className="relative group">
      ...
      <div
        className="absolute left-0 mt-2 w-[800px] bg-white dark:bg-gray-900 shadow-xl rounded-lg opacity-0 invisible 
            group-hover:opacity-100 group-hover:visible transition-all duration-200 grid grid-rows-[auto,1fr] overflow-hidden"
      >
        ...
        <div className="relative">
          <img src="/nav.jpg" alt="Support" className="w-full h-full object-cover" />
