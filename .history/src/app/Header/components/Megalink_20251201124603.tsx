...
const Megalink = ({ label, url, submenus }: Props) => {
  return (
    <div className="relative group">
      ...
      <div
        className="absolute left-0 mt-2 w-[600px] bg-white dark:bg-gray-900 shadow-xl rounded-lg opacity-0 invisible 
            group-hover:opacity-100 group-hover:visible transition-all duration-200 grid grid-cols-[2fr,3fr] overflow-hidden"
      >
          ...
          {submenus &&
            submenus.map((submenu) => (
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 text-sm">
                  {label}
                </span>
              </a>
            ))}
        ...
        <div className="relative">
          <img src={img3.src} alt="Support" className="w-full h-full object-cover" />
