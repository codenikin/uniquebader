import img1 from '/src/assets/solutions/img1.jpg'
import img2 from '/src/assets/solutions/img2.jpg'
import img3 from '/src/assets/solutions/img3.png'
import img4 from '/src/assets/solutions/img4.png'
import img5 from '/src/assets/solutions/img5.jpg'
import img6 from '/src/assets/solutions/img6.jpg'
...
;<section className="py-24 px-4 bg-white">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-5xl font-bold text-center text-gray-900 mb-16 animate-fade-in relative">
      Our Solutions
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      {solutions.map((solution, index) => (
        <div className="group relative overflow-hidden rounded-xl shadow-2xl transform transition-all duration-500 hover:scale-105 hover:shadow-purple-500/25">
          <div className="relative h-[450px] w-full">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-purple-500/90 via-purple-400/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
              <h3 className="text-2xl font-bold text-white mb-3 tracking-wide">{solution.title}</h3>
