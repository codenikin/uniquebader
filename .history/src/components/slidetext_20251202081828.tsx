...
export default function SlidingTextBackground() {
  return (
    <div className="relative flex min-h-48 items-center justify-center bg-black overflow-hidden py-6">
      ...
      <h1 className="relative text-white text-5xl md:text-7xl font-bold z-10 text-center leading-tight tracking-wide">
        <span className="font-anton text-red-600">BADER TECH U.A.E</span>
