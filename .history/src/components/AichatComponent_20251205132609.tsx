        ...
        {showChatIcon && (
          ...
          >
            ...
            >
              ...
              <span className="absolute bottom-full right-0 mb-2 px-2 py-1  text-black text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                AI Assistant
              </span>
            </button>
          </motion.div>
