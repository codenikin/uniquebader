            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto w-full">
                ...
                <p className="mt-6 text-lg/8 text-gray-600 ">
                  We are expert in tensile fabric structures in U.A.E.Tensile fabric structures in
                  U.A.E.We provide the complete solution for Tensile membrane shades, Mild steel &
                  Stainless Steel fabrication & erection. Our service include Design, Drawing &
                  Engineering for Fabrication &Tensile membrane structures Civil maintenance work
                  and Machinery repairing & trading.
                </p>
              </div>
