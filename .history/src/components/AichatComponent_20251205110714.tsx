      ...
      <AnimatePresence>
        {isChatOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="fixed bottom-20 right-4 z-50 md:w-[500px] w-[90vw] max-h-[calc(100vh-120px) flex flex-col"
          >
            <Card className="border-2 h-full flex flex-col shadow-xl rounded-lg bg-white">
