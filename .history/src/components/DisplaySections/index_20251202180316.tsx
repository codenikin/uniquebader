<section className="py-20 bg-linear-to-br from-gray-900 via-blue-900 to-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="inline-block px-3 py-1 rounded-full bg-blue-500/20 text-blue-300 text-sm font-medium tracking-wider">EDUCATIONAL SOLUTIONS</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-4 mb-6">What Lovosis Display Offers</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          <!-- Solution 1: Teacher-Student Interaction -->
          <div className="bg-white/5 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-white/10 hover:border-blue-500/30 hover:shadow-blue-500/10 transition-all duration-300">
            <div className="relative h-52 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4">
                <span className="px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded-full">Interactive Learning</span>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-gray-300">InstaHub series delivers exceptional audio-visual performance with seamless integration of educational software resources.</p>
                </div>
              </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-white/10 hover:border-purple-500/30 hover:shadow-purple-500/10 transition-all duration-300">
            <div className="relative h-52 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-linear-to-t from-gray-900/80 via-gray-900/40 to-transparent"></div>
              <div className="absolute bottom-4 left-4">
                <span className="px-3 py-1 bg-purple-600 text-white text-xs font-medium rounded-full">Multi-touch</span>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-gray-300">Experience fluid writing, easy modification, and seamless content sharing with our advanced touchscreen displays.</p>
                </div>
              </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-white/10 hover:border-green-500/30 hover:shadow-green-500/10 transition-all duration-300">
            <div className="relative h-52 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-linear-to-t from-gray-900/80 via-gray-900/40 to-transparent"></div>
              <div className="absolute bottom-4 left-4">
                <span className="px-3 py-1 bg-green-600 text-white text-xs font-medium rounded-full">All-in-One</span>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-gray-300">Replace multiple devices with one integrated solution, eliminating cable clutter and maximizing classroom space.</p>
                </div>
              </div>
