;<section className="py-20 bg-linear-to-br from-gray-900 via-blue-900 to-gray-900">
  <div className="container mx-auto px-4">
    <div className="text-center max-w-3xl mx-auto mb-12">
      <span className="inline-block px-3 py-1 rounded-full bg-blue-500/20 text-blue-300 text-sm font-medium tracking-wider">
        EDUCATIONAL SOLUTIONS
      </span>
      <h2 className="text-3xl md:text-5xl font-bold text-white mt-4 mb-6">
        What Lovosis Display Offers
      </h2>
      <div className="w-16 h-0.5 bg-linear-to-r from-blue-400 to-purple-400 mx-auto mb-6"></div>
      <p className="text-lg text-gray-300">
        Empowering educators with intelligent, digital classroom solutions designed to enhance
        ...
        <div className="p-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-300">
                Experience fluid writing, easy modification, and seamless content sharing with our
                advanced touchscreen displays.
              </p>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-300">
                Replace multiple devices with one integrated solution, eliminating cable clutter and
