        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-3 max-w-xs">
              Bader Technical works LLC provide the complete solution for Tensile membrane
              shades,Mild steel & stainless steel fabrication and erection.Our service include
              Design drawing and Engineering for fabrication&tensile membrane structures civil
              maintainance work and Mechinery repairing and trading.
            </p>
            <div className="flex space-x-2">
              <a
                ...
                className="w-8 h-8 bg-[#1e73be] rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-all duration-300"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Visit our Instagram page"
                className="w-8 h-8 bg-[#1e73be] rounded-full flex items-center justify-center text-white hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
              >
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-black">
              <div className="flex items-start space-x-2">
                <svg
                  className="w-4 h-4 text-[#1e73be] mt-0.5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-black">
              ...
              {/* <div className="flex items-start space-x-2">
                ...
                <Link href="tel:+919442532024" className="hover:text-blue-600"></Link>
              </div> */}
            </div>
          </div>
