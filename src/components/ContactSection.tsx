...
const ContactForm = () => {
  return (
    <div className="Container mt-32 bg-BodyBg-0 mb-32  p-8 ">
      <div className="grid grid-cols-2 lg:grid-cols-3 lg:items-center gap-10 lg:gap-0 max-w-7xl mx-auto">
        <div className="col-span-2 lg:col-span-1 rounded-md overflow-hidden inline-block">
          <img src="/bader2.png" className="w-full" draggable="false" />
          <div className="bg-blue-500 pl-9 pt-7 pb-9">
          ...
          <form action="#" method="post" className="flex flex-col gap-7">
            <div className="flex flex-col md:flex-row gap-7">
              <input
                ...
                required
                className="border border-gray-300 rounded py-2 px-6 outline-none h-[56px] w-full"
              />
              <input
                type="text"
                name="number"
            ...
            <textarea
              ...
              className="border border-gray-300 rounded py-2 px-6 outline-none resize-none h-[140px] w-full"
            ></textarea>
            <div className="inline-block mt-3">
              <button
                type="submit"
                className="primary-btn bg-blue-500 hover:border-PrimaryColor-0! border-blue-600 before:bg-blue-400"
              >
                Submit Message
              </button>
            </div>
