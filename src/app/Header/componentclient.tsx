          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                ...
                {/* Navigation Menu */}
                <nav className="flex-1 flex flex-col p-6 space-y-3 overflow-y-auto">
                  {headerdata.navItems?.map((item) => (
                    <a
                      key={item.id}
                      href={item.link.url}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-start space-x-3 group">
                    <FiPhone className="w-5 h-5 text-[#1e73be] mt-1 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <FiMail className="w-5 h-5 text-[#1e73be] mt-1 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <FiMapPin className="w-5 h-5 text-[#1e73be] mt-1 flex-shrink-0" />
                    <div>
                ...
                {/* Social Icons */}
                <div className="p-6">
                  <h3 className="text-sm font-semibold text-gray-800 mb-4 uppercase tracking-wide">Follow Us</h3>
